...
$(BUILDDIR)/scheduler_test.o: $(KERNELDIR)/process/scheduler_test.c | $(BUILDDIR)
> $(CC) $(CFLAGS) -c $< -o $@

$(BUILDDIR)/process_scheduler_test.o: $(KERNELDIR)/process/process_scheduler_test.c | $(BUILDDIR)
> $(CC) $(CFLAGS) -c $< -o $@

$(BUILDDIR)/process_termination_test.o: $(KERNELDIR)/process/process_termination_test.c | $(BUILDDIR)
> $(CC) $(CFLAGS) -c $< -o $@
